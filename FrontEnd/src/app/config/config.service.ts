...
export class ConfigService {
  ...
  loginserviceUrl = "http://localhost:8080/authmicroservice"

  //offer microservice
  offerserviceUrl = "http://localhost:8081/offermicroservice"

  //employee microservice
  employeeserviceUrl = "http://localhost:8082/employee"

  //points microservice
  pointsserviceUrl = "http://localhost:8083/points"
  ...
  getAllOffers(token: string) {
    ...
    return this.http.get<Offer[]>(this.offerserviceUrl + "/getAllOffer/" , options)
  }
  ...
  updateLike(token: string, id: number) {
    let options = {
      headers: { "Authorization": "Bearer " + token }
    }
    return this.http.post(this.offerserviceUrl + "/updateLikes/" + id, null, options)
  }
